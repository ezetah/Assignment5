...
namespace Assignment5.Controllers
{
    public class GenresController : Controller
    {
        ...
        public GenresController(Assignment5Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,genreTitle")] Genre genre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,genreTitle")] Genre genre)
        {
            if (id != genre.Id)
            {
                return NotFound();
